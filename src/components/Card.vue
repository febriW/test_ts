...
<template>
<div class="max-w-[250px] max-h-[265px] mx-auto">
    <div class="bg-white shadow-md rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="px-5 pb-5">
            <div class="pt-6">
                <span class="text-sm p-3">In Stock</span>
                <a href="#">
                    <img class="p-3" src="https://rgbtest.s3.ap-southeast-1.amazonaws.com/images/gift/full/xiaomi-mi-a2-lite.jpg" alt="product image">
                </a>
            </div>
            <div>
            ...
            <div class="flex items-center "> <!-- Rating -->
                ...
                <span class="text-gray-300 text-xs font-semibold mr-2 ml-2">160 Reviews</span>
                <span>
                    <div>
                        <IconHeartFill />
                    </div>
